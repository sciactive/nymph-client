(function (global, factory) {
  ...
  */
  ...
  var filterPhpMessages = function filterPhpMessages(text) {
    var phpMessages = /<br \/>\n(<b>[\w ]+<\/b>:.*?)<br \/>\n/gm;
    ...
    return function () {
      if (this.readyState === 4) {
        if (this.status >= 200 && this.status < 400) {
          var response = filterPhpMessages(this.responseText);
  ...
  var Nymph = function () {
    ...
    _createClass(Nymph, [{
      ...
      value: function getEntity(options) {
        ...
        return new Promise(function (resolve, reject) {
          _this6.getEntityData.apply(_this6, [options].concat(selectors)).then(function (data) {
            if (data !== null) {
      ...
      value: function getEntities(options) {
        ...
        return new Promise(function (resolve, reject) {
          getAjax({
            ...
            success: function success(data) {
              resolve(map(data, _this8.initEntity.bind(_this8)));
            },
            error: function error(errObj) {
              reject(errObj);
            }
      ...
      key: 'initEntitiesFromData',
      value: function initEntitiesFromData(item) {
        if (isArray(item)) {
          // Recurse into lower arrays.
          return map(item, this.initEntitiesFromData.bind(this));
        } else if (item instanceof Object && !(item instanceof this.getEntityClass('Entity'))) {
          if (item.hasOwnProperty('class') && Nymph.getEntityClass(item.class) && item.hasOwnProperty('guid') && item.hasOwnProperty('cdate') && item.hasOwnProperty('mdate') && item.hasOwnProperty('tags') && item.hasOwnProperty('data')) {
      ...
      value: function serverCall(entity, method, params) {
        ...
        return new Promise(function (resolve, reject) {
          postputdelAjax({
            ...
            success: function success(data) {
              resolve(_this10.initEntitiesFromData(data));
            },
            error: function error(errObj) {
              reject(errObj);
            }
      ...
      value: function serverCallStatic(className, method, params) {
        ...
        return new Promise(function (resolve, reject) {
          postputdelAjax({
            ...
            success: function success(data) {
              resolve(_this11.initEntitiesFromData(data));
            },
            error: function error(errObj) {
              reject(errObj);
            }
      ...
      value: function hsort(array, property, parentProperty, caseSensitive, reverse) {
        ...
        while (array.length) {
          ...
          for (var key = 0; key < array.length; key++) {
            ...
            if (typeof array[key].data[parentProperty] === 'undefined' || array[key].data[parentProperty] === null || typeof array[key].data[parentProperty].inArray !== 'function' || !array[key].data[parentProperty].inArray(newArray.concat(array))) {
              ...
              if (pkey !== false) {
                ...
                newKey = Number(pkey);
                while (typeof newArray[newKey + 1] !== 'undefined' && typeof newArray[newKey + 1].data[parentProperty] !== 'undefined' && newArray[newKey + 1].data[parentProperty] !== null && ancestry.indexOf(newArray[newKey + 1].data[parentProperty].guid) !== -1) {
  ...
  var NymphInvalidResponseError = function (_extendableBuiltin6) {
    _inherits(NymphInvalidResponseError, _extendableBuiltin6);

    function NymphInvalidResponseError(message) {
      _classCallCheck(this, NymphInvalidResponseError);

      var _this14 = _possibleConstructorReturn(this, (NymphInvalidResponseError.__proto__ || Object.getPrototypeOf(NymphInvalidResponseError)).call(this, message));

      _this14.name = 'NymphInvalidResponseError';
      return _this14;
    }

    return NymphInvalidResponseError;
  ...
  exports.NymphInvalidResponseError = NymphInvalidResponseError;
